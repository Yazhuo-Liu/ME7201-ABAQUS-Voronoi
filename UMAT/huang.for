...
c  
c  NOTE:  Modified to be compatible with ABAQUS-2021 and fortran-90 (Yazhuo).
c        Before starting to use this subroutine, please read Note (4) carefully.
c 
...
c
c  =========================Please Read==========================================
c  (4)  Note added by J. W. Kysar (4 November 1997).  This UMAT has been
